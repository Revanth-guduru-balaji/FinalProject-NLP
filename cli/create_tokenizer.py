...
def main():
    ...
    source_iterator = (item["article"] for item in raw_datasets["train"])
    ...
    logger.info(f"Saving source to {args.save_dir}/source_tokenizer")
    source_tokenizer.save_pretrained(os.path.join(args.save_dir, f"source_tokenizer"))
    # YOUR CODE ENDS HERE
    ...
    target_iterator = (item["highlights"] for item in raw_datasets["train"])
    ...
    logger.info(f"Saving source to {args.save_dir}/target_tokenizer")
    target_tokenizer.save_pretrained(os.path.join(args.save_dir, f"target_tokenizer"))
    # YOUR CODE ENDS HERE
